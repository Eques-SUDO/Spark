...
const WhatsAppButton = () => {
  const phoneNumber = '212682233612' // Remove + and format for WhatsApp
  const message = 'Bonjour Spark Morocco! Je souhaite en savoir plus sur vos services.'
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            <div className="bg-gray-900 text-white text-sm rounded-lg px-3 py-2 whitespace-nowrap">
              ...
              <div className="absolute top-full right-4 w-0 h-0 border-l-[6px] border-l-transparent border-r-[6px] border-r-transparent border-t-[6px] border-t-gray-900"></div>
            </div>
          </div>
        </div>
      </a>
